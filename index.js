...
//connect to mongodb
const uri = "mongodb+srv://Gamers:cQ6mKUO2kYKzXBen@cluster0.8ngda.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
async function run() {
  try {
    await client.connect((err) => {
      const db = client.db("Gamers");
      const djiPackages = db.collection("Laptop");
      ...
      //GET API
      app.get("/", (req, res) => {
        res.send("Welcome To Republic Of Gamers Server !!");
      });
